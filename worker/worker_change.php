...
<div class="admin">
  ...
  <form method="post" action="worker_change.php?worker_id=<?php echo $one['worker_id'] ?>">
    <div class="panel admin-panel">
        ...
        <table class="table table-hover">
            <tr>
                ...
                <td><input type="text" name="worker_no" value="<?php echo $one['worker_no'] ?> "readonly class="input input30"/>
                </td>
            </tr>
            <tr>
...
<?php
	...
	if(!empty($data)){
		...
		$name = $data['name'];
        $phone = $data['phone'];
        $sql = " update worker set `password`='$password'";
